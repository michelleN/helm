...
// TestReleaseRequest is the request for running tests of a chart.
...
func (*TestReleaseRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }

// TestReleaseResponse is the response from testing a release
...
func (*TestReleaseResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{10} }

func (m *TestReleaseResponse) GetRelease() *hapi_release3.Release {
	if m != nil {
		return m.Release
	}
	return nil
...
type ReleaseServiceClient interface {
	...
	// TestRelease requests runs tests of a named release.
	TestRelease(ctx context.Context, in *TestReleaseRequest, opts ...grpc.CallOption) (*TestReleaseResponse, error)
}
...
func (c *releaseServiceClient) TestRelease(ctx context.Context, in *TestReleaseRequest, opts ...grpc.CallOption) (*TestReleaseResponse, error) {
	out := new(TestReleaseResponse)
	err := grpc.Invoke(ctx, "/hapi.services.tiller.ReleaseService/TestRelease", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReleaseServiceServer interface {
	...
	// TestRelease requests runs tests of a named release.
	TestRelease(context.Context, *TestReleaseRequest) (*TestReleaseResponse, error)
}
...
func _ReleaseService_TestRelease_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(TestReleaseRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	out, err := srv.(ReleaseServiceServer).TestRelease(ctx, in)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _ReleaseService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ReleaseService_TestRelease_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
